...
class BuckarooPaymentMethods
{
    ...
    protected function getEmptyClasses()
    {
        $classes = [
            ...
            'BuckarooPayment\PaymentMethods\Billink',
            ...
            'BuckarooPayment\PaymentMethods\PostePay',
    ...
    protected function getClasses()
    {
        $services = [
            ...
            "buckaroo_payment.payment_methods.billink",
            ...
            "buckaroo_payment.payment_methods.postepay",
