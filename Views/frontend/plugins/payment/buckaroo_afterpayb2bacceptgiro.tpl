{namespace name=frontend/plugins/payment/buckaroo_afterpayb2bacceptgiro}

{assign var="name" value="afterpayb2bacceptgiro"}
...
{include file='frontend/_includes/fields/user_buckaroo_payment_iban.tpl' name=$name}
