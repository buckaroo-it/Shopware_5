...
class Shopware_Controllers_Backend_BuckarooAfterPayNewRefund extends Shopware_Controllers_Api_Rest implements CSRFWhitelistAware
{
    ...
    public function setServiceParameters($request, $order, $order_details, $refundedArticleIds, $orderDetailId, $invoice){
        ...
        foreach ($order_details as $detail) {
            ...
            if (in_array($order_detail_article_id, $refundedArticleIds)) {
                ...
                $request->setServiceParameter('RefundType', 'Return', $groupType = 'Article', $groupId = $y);
